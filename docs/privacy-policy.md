...
This privacy policy applies to the Fishlog app (hereby referred to as "Application") for mobile
devices that was created by Fishlog Team (hereby referred to as "Service Provider") as a Free
...
provide us with certain personally identifiable information, including but not limited to username,
...
Service Provider (harissabildev@gmail.com) so that they will be able to take the necessary actions.
...
practices, please contact the Service Provider via email at harissabildev@gmail.com.
